...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/business/bus-post-focus/post-focus_1.png')}}" alt="" />
        <a href="{{asset('/read-business')}}">
            <img src="{{asset('images/business/bus-post-focus/post-focus_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/business/bus-post-focus/post-focus_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/business/bus-post-focus/post-focus_4.png')}}" alt="" />
        <img src="{{asset('images/business/bus-post-focus/post-focus_5.png')}}" alt="" />
        <img src="{{asset('images/business/bus-post-focus/post-focus_6.png')}}" alt="" />
    </div>
