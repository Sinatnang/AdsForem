...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/lifestyle/life-food-drink/food-drink_1.png')}}" alt="" />
        <a href="{{asset('/read-lifestyle')}}">
            <img src="{{asset('images/lifestyle/life-food-drink/food-drink_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-food-drink/food-drink_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-food-drink/food-drink_4.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-food-drink/food-drink_5.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-food-drink/food-drink_6.png')}}" alt="" />
    </div>
