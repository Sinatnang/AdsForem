...
<div class="row mt-2">
                ...
                <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_1.png')}}" alt="" />
                <div class="col-8">
                    <!-- <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_2.png')}}" alt="" />
                    <a class="footclose" href="#" >
                    <img src="https://tpc.googlesyndication.com/simgad/8457811643808958112" alt="" >
                    </a> -->
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_3.png')}}" alt="">
                    <div class="parallax"></div>
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_4.png')}}" alt=""> 
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_5.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_6.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_7.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_8.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_9.png')}}" alt="">
                </div>
                <div class="col-4 mt-1 block-ads">
                    ...
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_10.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/read-lifestyle/lifestyle_11.png')}}" alt="">
                    </div>
                </div>
@endsection
