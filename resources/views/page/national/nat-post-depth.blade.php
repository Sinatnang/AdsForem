...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/national/nat-post-depth/post_depth_1.png')}}" alt="" />
        <a href="{{asset('/read-national')}}">
            <img src="{{asset('images/national/nat-post-depth/post_depth_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/national/nat-post-depth/post_depth_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/national/nat-post-depth/post_depth_4.png')}}" alt="" />
        <img src="{{asset('images/national/nat-post-depth/post_depth_5.png')}}" alt="" />
        <img src="{{asset('images/national/nat-post-depth/post_depth_6.png')}}" alt="" />
    </div>
