...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/business/bus-post-auto/post-auto_1.png')}}" alt="" />
        <a href="{{asset('/read-business')}}">
            <img src="{{asset('images/business/bus-post-auto/post-auto_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/business/bus-post-auto/post-auto_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/business/bus-post-auto/post-auto_4.png')}}" alt="" />
        <img src="{{asset('images/business/bus-post-auto/post-auto_5.png')}}" alt="" />
        <img src="{{asset('images/business/bus-post-auto/post-auto_6.png')}}" alt="" />
    </div>
