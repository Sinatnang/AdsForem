...
*/
    ...
    ea("Promise", function (a) {
        ...
        e.prototype.v = function (k) {
            if (k === this) this.s(new TypeError("A Promise cannot resolve to itself"));
        ...
        e.all = function (k) {
            ...
            return m.done
                ...
                : new e(function (p, r) {
                      ...
                      var N = [],
                          Y = 0;
                      do N.push(void 0), Y++, c(m.value).bb(G(N.length - 1), r), (m = l.next());
                      while (!m.done);
                  });
        };
        return e;
        ...
        return a
            ...
            : function (b, c) {
                  ...
                  var e = d.length,
                      f = b.length;
                  c = Math.max(0, Math.min(c | 0, d.length));
                  for (var k = 0; k < f && c < e; ) if (d[c++] != b[k++]) return !1;
                  return k >= f;
              };
    });
    var ya = function (a, b) {
    ...
    ea("WeakMap", function (a) {
        ...
        l.prototype.has = function (m) {
            return c(m) && ya(m, f) && ya(m[f], this.a);
        };
    ...
    ea("Map", function (a) {
        ...
        c.prototype.set = function (l, m) {
            ...
            p.X ? (p.X.value = m) : ((p.X = { next: this.a, ra: this.a.ra, head: this.a, key: l, value: m }), p.list.push(p.X), (this.a.ra.next = p.X), (this.a.ra = p.X), this.size++);
            return this;
        };
        c.prototype.delete = function (l) {
            l = d(this, l);
            return l.X && l.list ? (l.list.splice(l.index, 1), l.list.length || delete this.b[l.id], (l.X.ra.next = l.X.next), (l.X.next.ra = l.X.ra), (l.X.head = null), this.size--, !0) : !1;
        };
        ...
        var d = function (l, m) {
                ...
                if (r && ya(l.b, p))
                    for (l = 0; l < r.length; l++) {
                        var G = r[l];
                        if ((m !== m && G.key !== G.key) || m === G.key) return { id: p, list: r, index: l, X: G };
                    }
    ...
    Ta.Type = { LIVE: 1, LOCAL: 2, BROWSER: 4, IN_APP: 8, LAYOUTS_PREVIEW: 16, CREATIVE_TOOLSET: 32, RENDERING_STUDIO: 64, RENDERING_TEST: 128, PREVIEW: 256 };
    var Ua = 6;
    ...
    var ab = function (a, b, c, d) {
        ...
        db = function (a, b, c) {
            "string" !== typeof a && ab("Expected string but got %s: %s.", [Ga(a), a], b, Array.prototype.slice.call(arguments, 2));
        },
        eb = function (a, b, c) {
    ...
    var dc = function (a, b) {
        ...
        if (e && "undefined" != typeof e[b] && (!a || (!(a instanceof e[b]) && (a instanceof e.Location || a instanceof e.Element)))) {
            ...
            bb("Argument is not a %s (or a non-Element, non-Location mock); got: %s", b, f);
        }
    };
    var ec = function () {
        return null;
    ...
    var oc = function (a) {
        ...
        tc = function (a) {
            var b = kc(pc);
            if (!qc.test(b)) throw Error("Invalid TrustedResourceUrl format: " + b);
    ...
    var xc = function (a) {
        ...
        vc = {},
        Bc = new wc(uc, "about:invalid#zClosurez"),
        uc = {};
    var Dc = function () {
        this.a = "";
        this.b = Cc;
    ...
    var Ec = function (a) {
        ...
        Gc = function (a) {
            ...
            if (Kc.test(b)) {
                if (Lc.test(a)) return bb("String value disallows comments, got: " + a), "zClosurez";
                for (var c = (b = !0), d = 0; d < a.length; d++) {
                    var e = a.charAt(d);
                    "'" == e && c ? (b = !b) : '"' == e && b && (c = !c);
                }
                if (!b || !c) return bb("String value requires balanced quotes, got: " + a), "zClosurez";
                if (!Mc(a)) return bb("String value requires balanced square brackets and one identifier per pair of brackets, got: " + a), "zClosurez";
            } else return bb("String value allows only [-,.\"'%_!# a-zA-Z0-9\\[\\]] and simple functions, got: " + a), "zClosurez";
            return Nc(a);
        },
        Mc = function (a) {
    ...
    var Oc = {},
        Rc = function (a, b) {
            if (Kb(a, "<")) throw Error("Selector does not allow '<', got: " + a);
            var c = a.replace(/('|")((?!\1)[^\r\n\f\\]|\\[\s\S])*\1/g, "");
    ...
    var Uc = function (a) {
            if (a instanceof Tc && a.constructor === Tc && a.b === Sc) return a.a;
    ...
    var jd = A("Opera"),
        ...
        od = Kb(Nb.toLowerCase(), "webkit") && !A("Edge"),
        pd = function () {
            var a = n.document;
    ...
    a: {
        var rd = "",
            sd = (function () {
                var a = Nb;
                if (nd) return /rv:([^\);]+)(\)|;)/.exec(a);
                if (ld) return /Edge\/([\d\.]+)/.exec(a);
                if (kd) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
                if (od) return /WebKit\/(\S+)/.exec(a);
                if (jd) return /(?:Version)[ \/]?(\S+)/.exec(a);
            })();
        sd && (rd = sd ? sd[1] : "");
        if (kd) {
            var td = pd();
    ...
    var Yd = new Xd("OFF", Infinity),
        Zd = new Xd("SHOUT", 1200),
        $d = new Xd("SEVERE", 1e3),
        ae = new Xd("WARNING", 900),
        be = new Xd("INFO", 800),
        ce = new Xd("CONFIG", 700),
        de = new Xd("FINE", 500),
        ee = new Xd("FINER", 400),
        fe = new Xd("FINEST", 300),
        ge = new Xd("ALL", 0),
        he = [Yd, Zd, $d, ae, be, ce, de, ee, fe, ge],
        ie = null;
    ...
    var Je = function (a, b, c) {
        ...
        Re = function (a, b, c, d) {
            if (a instanceof Le)
                return (
                    null != b && eb(b, "opt_onFulfilled should be a function."),
                    null != c && eb(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"),
                    $e(a, Oe(b || Da, c || null, d)),
                    !0
                );
            if (Ie(a)) return a.then(b, c, d), !0;
            if (t(a))
                try {
                    var e = a.then;
                    if (Ja(e)) return bf(a, e, b, c, d), !0;
                } catch (f) {
                    return c.call(d, f), !0;
                }
            return !1;
    ...
    var Ye = function (a, b, c, d) {
            if (3 == c && b.f && !b.g) for (; a && a.s; a = a.f) a.s = !1;
            if (b.a) (b.a.f = null), cf(b, c, d);
            else
                try {
...
*/
    ...
    H.prototype.cancel = function (a) {
        if (this.a) this.f instanceof H && this.f.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
            ...
            for (var d = (c = !1); a.j.length && !a.o; ) {
                ...
                if ((f = a.g ? k : f))
                    try {
                        ...
                        if (Ie(b) || ("function" === typeof n.Promise && b instanceof n.Promise)) (d = !0), (a.o = !0);
                    } catch (m) {
                        (b = m), (a.g = !0), of(a) || (c = !0);
                    }
            }
            a.f = b;
            d && ((l = u(a.B, a, !0)), (d = u(a.B, a, !1)), b instanceof H ? (lf(b, l, d), (b.Y = !0)) : b.then(l, d));
    ...
    var I = function (a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof I) for (c = a.R(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
    ...
    g.Na = function (a) {
        for (var b = 0; b < this.a.length; b++) {
            var c = this.a[b];
            if (xf(this.b, c) && this.b[c] == a) return !0;
        }
        return !1;
    };
    var yf = function (a) {
    ...
    J.prototype.A = function () {
        if (this.Y) for (; this.Y.length; ) this.Y.shift()();
    };
    var Af = function (a) {
    ...
    var Rf = function (a, b) {
        ...
        Qf = function (a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.Ja && f.listener == b && f.capture == !!c && f.Ia == d) return e;
            }
            return -1;
        };
    var Vf = "closure_lm_" + ((1e6 * Math.random()) | 0),
        ...
        Zf = function (a, b, c, d, e) {
            if (d && d.once) return Yf(a, b, c, d, e);
            if (Array.isArray(b)) {
        ...
        ag = function (a, b, c, d, e, f) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) Hf || (e = k), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
        ...
        fg = function (a, b, c, d, e) {
            ...
            else (d = t(d) ? !!d.capture : !!d), (c = $f(c)), Lf(a) ? a.Pa(b, c, d, e) : a && (a = bg(a)) && (b = Tf(a, b, c, d, e)) && gg(b);
        },
        gg = function (a) {
            if ("number" === typeof a || !a || a.Ja) return !1;
            var b = a.src;
            if (Lf(b)) return Rf(b.g, a);
            var c = a.type,
                d = a.a;
        ...
        ig = function (a, b) {
            if (Lf(a)) return Uf(a.g, void 0 !== b ? String(b) : void 0);
            a = bg(a);
            return !!a && Uf(a, b);
        },
        dg = function (a) {
            ...
            if ((a = bg(a)))
                if ((b = a.a[b.toString()]))
                    for (b = b.concat(), a = 0; a < b.length; a++) {
                        var f = b[a];
                        f && f.capture == c && !f.Ja && ((f = jg(f, d)), (e = e && !1 !== f));
                    }
            return e;
        },
        jg = function (a, b) {
        ...
        eg = function (a, b) {
            ...
            if (!Ff) {
                ...
                if (!(0 > c.keyCode || void 0 != c.returnValue)) {
                    ...
                    for (e = 0; !b.b && e < c.length; e++) (b.a = c[e]), (f = kg(c[e], a, !1, b)), (d = d && f);
                }
                return d;
            }
    ...
    g.dispatchEvent = function (a) {
        ...
        b = this.re;
        d = a.type || a;
        if ("string" === typeof a) a = new Df(a, b);
        else if (a instanceof Df) a.target = a.target || b;
        else {
            var e = a;
            a = new Df(d, b);
            ac(a, e);
        ...
        if (c) for (f = 0; !a.b && f < c.length; f++) (k = a.a = c[f]), (e = ng(k, d, !1, a) && e);
        return e;
    };
    g.A = function () {
        K.H.A.call(this);
    ...
    g.hf = function () {
        if (this.Fa) {
            var a = Qa() - this.h;
            0 < a && a < 0.8 * this.b ? (this.ia = this.a.setTimeout(this.f, this.b - a)) : (this.ia && (this.a.clearTimeout(this.ia), (this.ia = null)), this.dispatchEvent("tick"), this.Fa && (this.stop(), this.start()));
        }
    };
    g.start = function () {
        this.Fa = !0;
    ...
    var yg = function (a) {
        ...
        Ag = function (a, b) {
            ...
            for (var c = xg(a), d = vf(se(c)), e = 0; e < b; ++e)
                d = d.then(void 0, function () {
                    return vf(se(c));
                });
            return d.then(
                function () {
    ...
    var Dg = [],
        ...
        Eg = function (a, b, c, d, e, f) {
            if (Array.isArray(c)) for (var k = 0; k < c.length; k++) Eg(a, b, c[k], d, e, f);
            else (b = Yf(b, c, d || a.handleEvent, e, f || a.l || a)) && (a.f[b.key] = b);
        },
        Fg = function (a, b, c, d, e, f) {
            if (Array.isArray(c)) for (var k = 0; k < c.length; k++) Fg(a, b, c[k], d, e, f);
            else if ((b = hg(b, c, d || a.handleEvent, t(e) ? !!e.capture : !!e, f || a.l || a))) gg(b), delete a.f[b.key];
        },
        Gg = function (a) {
            Qb(
                a.f,
        ...
        return Hg(this, function c() {
            ...
            return wa(c, function (k) {
                switch (k.a) {
                    ...
                    case 3:
                        return e
                            ? (f = a.hb || e.sodar_query_id) && e.bg_hash_basename && e.bg_binary
                                ? k.return({ context: a.f, kd: e.bg_hash_basename, jd: e.bg_binary, ue: a.a + "_" + a.b, hb: f, za: a.za })
                                : k.return(void 0)
                            : k.return(void 0);
                }
            });
    ...
    var Wg = function () {},
        ...
        Zg = Object.freeze ? Object.freeze([]) : [],
        $g = function (a, b) {
            if (b < a.s) {
                b += a.g;
                var c = a.a[b];
            ...
            if (a.b) return (c = a.b[b]), c === Zg ? (a.b[b] = []) : c;
        },
        ah = function (a, b) {
            a.f || (a.f = {});
            if (!a.f[1]) {
    ...
    var hh = new fh();
    q(
        "studio.common.Feature.hasFeature",
        function (a) {
    ...
    q(
        "studio.common.Feature.hasFeatures",
        function (a) {
            var b = hh;
            a: {
                var c = b.contains;
                if ("function" == typeof a.every) a = a.every(c, b);
                else if (Ia(a) || "string" === typeof a) a = nb(a, c, b);
                else {
                    if (a.R && "function" == typeof a.R) var d = a.R();
                    else if (a.N && "function" == typeof a.N) d = void 0;
    ...
    var Ih = function (a) {
        ...
        var d = yh[a];
        if (d) return d.ja(c, b), !0;
        d = Hh(b)[0];
        for (var e in yh) {
            var f = yh[e];
            if (1 == f.U() && !f.isConnected() && "tp" == c && "SETUP" == d) return f.Ba(a), f.ja(c, b), !0;
        }
    ...
    g.connect = function () {
        ...
        if (a) {
            ...
            this.B = !0;
            this.$c();
        } else pe(O, "connect(): no window to initialize.");
    };
    g.$c = function () {
    ...
    g.Zc = function (a) {
        ...
        if (null === c) D(O, "Peer window had no global function.");
        else
            try {
                c({ channelName: a.a, service: a.f, payload: a.b }), E(O, "send(): channelName=" + a.a + " service=" + a.f + " payload=" + a.b);
            } catch (d) {
    ...
    var Lh = function (a, b, c, d, e) {
        ...
        E(O, "NativeMessagingTransport created.  protocolVersion=" + this.b + ", oneSidedHandshake=" + this.v + ", role=" + this.f.U());
    };
    h(Lh, Dh);
    var Nh = function (a) {
        var b = a.$.data;
        ...
        if ((d = yh[e])) return d.ja(c, b, a.$.origin), !0;
        d = Mh(b)[0];
        for (var f in yh) {
            var k = yh[f];
            if (1 == k.U() && !k.isConnected() && "tp" == c && ("SETUP" == d || "SETUP_NTPV2" == d) && k.Sa(a.$.origin)) return k.Ba(e), k.ja(c, b), !0;
        }
        E(O, 'channel name mismatch; message ignored"');
        return !1;
    };
            ...
            if (null == b) c.push("null");
                ...
                if ("object" == typeof b) {
                    ...
                    if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                        ...
                        c.push("{");
                        e = "";
                        for (d in b) Object.prototype.hasOwnProperty.call(b, d) && ((f = b[d]), "function" != typeof f && (c.push(e), Xh(d, c), c.push(":"), Uh(a, f, c), (e = ",")));
                        c.push("}");
                        return;
                    }
                }
    ...
    var ai = function (a, b, c) {
        var d = a.l[b];
        d || (a.h ? (d = { I: Pa(a.h, b), Fc: t(c) }) : (D(a.qc, 'Unknown service name "' + b + '"'), (d = null)));
        if (d) {
            a: {
                var e = d.Fc;
    ...
    var bi = function (a) {
        ...
        var b;
        a instanceof bi
            ? ((this.h = a.h), ci(this, a.g), (this.j = a.j), (this.b = a.b), di(this, a.l), (this.a = a.a), ei(this, fi(a.f)), (this.s = a.s))
            : a && (b = String(a).match(nh))
            ? ((this.h = !1), ci(this, b[1] || "", !0), (this.j = gi(b[2] || "")), (this.b = gi(b[3] || "", !0)), di(this, b[4]), (this.a = gi(b[5] || "", !0)), ei(this, b[6] || "", !0), (this.s = gi(b[7] || "")))
            : ((this.h = !1), (this.f = new hi(null, this.h)));
    };
    bi.prototype.toString = function () {
        ...
        b && a.push(ii(b, ji, !0), ":");
        var c = this.b;
        if (c || "file" == b) a.push("//"), (b = this.j) && a.push(ii(b, ji, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), (c = this.l), null != c && a.push(":", String(c));
        if ((c = this.a)) this.b && "/" != c.charAt(0) && a.push("/"), a.push(ii(c, "/" == c.charAt(0) ? ki : li, !0));
        ...
        if (c) di(b, a.l);
            ...
            if (".." == e || "." == e) d = "";
                ...
                for (var f = [], k = 0; k < e.length; ) {
                    var l = e[k++];
                    "." == l ? d && k == e.length && f.push("") : ".." == l ? ((1 < f.length || (1 == f.length && "" != f[0])) && f.pop(), d && k == e.length && f.push("")) : (f.push(l), (d = !0));
                }
                d = f.join("/");
            } else d = e;
        }
    ...
    g.N = function (a) {
        qi(this);
        var b = [];
        if ("string" === typeof a) this.T(a) && (b = sb(b, this.a.get(ri(this, a))));
        else {
            a = this.a.N();
    ...
    var ui = function (a, b) {
        $h.call(this);
        for (var c = 0, d; (d = Ah[c]); c++) if (d in a && !/^https?:\/\//.test(a[d])) throw Error("URI " + a[d] + " is invalid for field " + d);
        this.a = a;
    ...
    ui.prototype.o = function () {
        ...
        if (!this.ha) {
            ...
            if ("function" === typeof this.a.tp) this.ha = new this.a.tp(this, this.f);
            else
                switch (this.a.tp) {
                    case 1:
            ...
            if (this.ha) E(O, "Transport created: " + (zh[String(this.ha.Ma)] || ""));
    ...
    ui.prototype.Ra = function (a, b) {
        ...
        } else oe(O, "Can't send. Channel not connected.");
    };
    ui.prototype.ja = function (a, b, c) {
        this.Aa
            ? this.g.push(u(this.ja, this, a, b, c))
            : this.Sa(c)
            ? this.s || 3 == this.La
                ? D(O, "CrossPageChannel::xpcDeliver(): Channel closed.")
                : a && "tp" != a
                ? this.isConnected()
                    ? ((a = a.replace(/%[0-9a-f]{2}/gi, decodeURIComponent)), (a = wi.test(a) ? a.substring(1) : a), ai(this, a, b))
                    : E(O, "CrossPageChannel::xpcDeliver(): Not connected.")
                : this.ha.Va(b)
            : D(O, 'Message received from unapproved origin "' + c + '" - rejected.');
    };
    var vi = function (a) {
        xi.test(a) && (a = "%" + a);
    ...
    g.ca = null;
    g.mb = null;
    var yi = { Bf: "devicemotion", Cf: "deviceorientation", Rf: "hostpageScroll", Gf: "enterViewport", Hf: "exitViewport", vf: "adLocation" },
        zi = {},
        Ai;
    ...
    var Ei = { TL: new Di(0), TR: new Di(1), BL: new Di(2), BR: new Di(3) },
        Fi = Tb(Ei);
    var Gi = {
        ...
        if (c) {
            ...
            d in this.a
                ? (c = this.a[d])
                    ? c.f
                        ? c.f(a, b)
                        : D(this.f, 'Service "' + a + '" is not registered on virtual channel "' + d + '"')
                    : D(this.f, 'Virtual channel "' + d + ' has been disposed, but a message was received for it: "' + a + '"')
                : D(this.f, 'Virtual channel "' + d + ' does not exist, but a message was received for it: "' + a + '"');
    ...
    q("studio.sdk.ContainerState", { COLLAPSING: "collapsing", COLLAPSED: "collapsed", EXPANDING: "expanding", EXPANDED: "expanded", FS_COLLAPSING: "fs_collapsing", FS_EXPANDING: "fs_expanding", FS_EXPANDED: "fs_expanded" }, void 0);
    var Ri = function () {
        L.call(this);
        this.a = new Map();
        this.g = this.j = !1;
    ...
    kj.prototype.B = function () {
        "1" == this.v.getParameter("isMouseOver") || 1 == this.o
            ? this.h ||
              ((this.C = !0),
              1 > this.j
                  ? (this.j = Qa())
                  : 1e3 < Qa() - this.j && ((this.h = !0), this.v.dispatchEvent(new P("interaction")), lj(this.v, "setTimerAdjustment", ["INTERACTION_TIMER", -1e3, 0]), this.g && (gj(this.g, "Start", "INTERACTION_TIMER"), ij(this.g))))
            : (this.h && mj(this), (this.j = -1));
    };
    var mj = function (a) {
        a.h = !1;
    ...
    zj.prototype.f = function (a) {
        function b(f) {
            if (f) {
                if (f.value >= $d.value) return "error";
                if (f.value >= ae.value) return "warn";
                if (f.value >= ce.value) return "log";
            }
            return "debug";
        }
        if (!this.g[a.b]) {
    ...
    var Gj = function (a, b, c) {
            if ("string" === typeof b) (b = Fj(a, b)) && (a.style[b] = c);
            else
                for (var d in b) {
                    c = a;
                    var e = b[d],
        ...
        Lj = function (a) {
            var b = Dd(void 0),
                c = b.a;
            if (kd && c.createStyleSheet) return (b = c.createStyleSheet()), Kj(b, a), b;
            c = Qd(b, "HEAD")[0];
            if (!c) {
                var d = Qd(b, "BODY")[0];
                c = b.b("HEAD");
        ...
        Kj = function (a, b) {
            b instanceof Pc && b.constructor === Pc && b.b === Oc ? (b = b.a) : (bb("expected object of type SafeStyleSheet, got '" + b + "' of type " + Ga(b)), (b = "type_error:SafeStyleSheet"));
            if (kd && void 0 !== a.cssText) a.cssText = b;
            else if (n.trustedTypes)
                if ((y(null != a, "goog.dom.setTextContent expects a non-null value for node"), "textContent" in a)) a.textContent = b;
    ...
    var R = function (a) {
        ...
        n.console && (Ej(), Bj());
        E(F, "");
        if (a != Oj) return oe(F, "You must access the enabler instance using studio.Enabler.getInstance(); or Enabler and not create a duplicate instance."), !1;
        K.call(this);
        this.v = {};
        this.j = {};
    ...
    var Tj = function (a) {
        ...
        Xj = function (a) {
            ...
            b = a.a;
            if (Vb(b.a, "assets") || b.b.T("assets")) (b = a.a.getParameter("assets").toString()), Vj(a, b);
            ...
            b.b.start();
            Wj(a);
            if ((b = a.getParameter("layoutsConfig"))) a.Xc = JSON.parse(String(b));
            if ((b = a.getParameter("experiments"))) a.Qb = JSON.parse(String(b));
    ...
    var Wj = function (a) {
        if (null != a.ea("dcData") || a.ub) window.dynamicContent = null != a.ea("dcData") ? a.eb() : a.ub;
    };
    ...
    var Zj = function (a) {
        ...
        ak = function (a, b) {
            ...
            a: {
                ...
                if (!Bb($c(e)) && -1 < e.indexOf("?")) for (b = "number" === typeof d ? d : 1, d = 0; d < b; d++) c = unescape(c);
                b = c;
            }
            return b;
        },
        bk = function (a, b, c, d) {
            ...
            if (fd() && e.navigator && e.navigator.standalone && b && "_self" != b)
                (l = Jd(document, "A")),
                    dc(l, "HTMLAnchorElement"),
                    (f = f instanceof wc ? f : Ac(f)),
                    (l.href = xc(f)),
                    l.setAttribute("target", b),
                    c.noreferrer && l.setAttribute("rel", "noreferrer"),
                    (c = document.createEvent("MouseEvent")),
                    c.initMouseEvent("click", !0, !0, e, 1),
                    l.dispatchEvent(c);
                ...
                if (
                    ...
                    (c = xc(f)),
                    e &&
                        (md && Kb(c, ";") && (c = "'" + c.replace(/'/g, "%27") + "'"),
                        (e.opener = null),
                        (f = new jc(hc, "b/12014412, meta tag with sanitized URL")),
                        (c = '<meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0; url=' + Yc(c) + '">'),
                        db(kc(f), "must provide justification"),
                        y(!Bb(kc(f)), "must provide non-empty justification"),
                        (f = new Tc()),
                        (b = gc()),
                        (f.a = b ? b.createHTML(c) : c),
                        (c = e.document)))
                )
                    c.write(Uc(f)), c.close();
            } else (e = Wc(f, e, b, l)) && c.noopener && (e.opener = null);
            d && a.o();
        },
        ...
        ek = function (a, b, c, d, e) {
            if (Bb($c(b))) E(F, "There was a problem with the exit call.");
            else if (a.isInitialized()) {
                var f = void 0 !== d ? d : 0;
                d = (a.j[b] && a.j[b].target) || "_blank";
                var k;
                if ((k = !w(8))) k = !(Kb(a.a.getParameter("click", ""), "[rm_exit_id]") && null != a.j[b] && null != a.j[b].reportingId && !Bb(a.j[b].reportingId));
                f = !(f & 1);
    ...
    var gk = function (a, b, c) {
        ...
        Uj = function (a, b, c) {
            a.oa() && !w(8) && (a.W && Mj(a.W), (a.W = Lj(Rc("body", { position: "relative", "margin-left": -b + "px !important", "margin-top": -c + "px !important" }))));
        };
    ...
    R.prototype.rb = function (a) {
        (this.Yc = a) && !this.Wa.visible
            ? (null != window.AdobeEdge && "function" === typeof window.AdobeEdge.playWhenReady && window.AdobeEdge.playWhenReady(),
              this.Wc && gj(this.b, "Start", "DISPLAY_TIMER", void 0, void 0, void 0),
              this.dispatchEvent(new P("visible")))
            : this.Wa.hidden || this.dispatchEvent(new P("hidden"));
    ...
    var hk = function (a, b) {
            if (!a.oa() && a.pb) {
                var c = document.getElementsByTagName("body")[0],
                    d = B("IMG", { width: "15", height: "15", border: "0", src: "http://s0.2mdn.net/ads/studio/close.png" });
                a.h = { I: b, element: B("DIV", { style: "position: absolute;right: 5px;top: 5px;width: 15px;height: 15px;cursor: pointer;" }, d) };
    ...
    R.prototype.vc = function (a) {
        ...
        this.f = "expanding";
        a = new P("expandStart");
        a.da("direction", this.sa);
        this.dispatchEvent(a);
    };
    R.prototype.startExpandInternal = R.prototype.vc;
    R.prototype.Bb = function () {
        "expanding" != this.f
            ? D(F, "You must first call Enabler.requestExpand() to initiate the expansion and then call Enabler.finishExpand() when the expand animation has  finished. Cancelling expansion...")
            : (Q(this.F, "expandFinished", [this.la]), (this.f = "expanded"), E(F, "The creative has expanded."), this.dispatchEvent(new P("expandFinish")));
    };
    ...
    R.prototype.Ab = function () {
        "collapsing" != this.f
            ? D(F, "You must first call Enabler.requestCollapse() to initiate the collapse and then call Enabler.finishCollapse() when the collapse animation has  finished. Cancelling collapse...")
            : (Q(this.F, "collapseFinished", [this.la]), this.l(this.Rb, 0));
    };
    ...
    R.prototype.Pc = function (a, b) {
        if ("collapsed" != this.f) D(F, "Enabler.requestFullscreenExpand() should not be invoked unless the  creative is in the collapsed state.");
            ...
            ig(this, "fullscreenExpandStart") ||
                D(F, "Please implement the fullscreen expansion via event handlers:\nEnabler.addEventListener(\n    studio.events.StudioEvent.FULLSCREEN_EXPAND_START,\n    function() {/* expand action */});");
            this.qb = !0;
            var c = [];
            a && b && (c = [a, b]);
            Q(this.F, "fullscreenExpandRequested", c);
            hk(this, this.Gb);
            this.l(this.Wb, 0, a, b);
        }
    };
    R.prototype.requestFullscreenExpand = R.prototype.Pc;
    R.prototype.hc = function () {
        "fs_expanding" != this.f
            ? D(F, "You must first call Enabler.requestFullscreenExpand() to initiate the expansion and then call Enabler.finishFullscreenExpand() when the expand animation has finished. Cancelling expansion...")
            : (Q(this.F, "fullscreenExpandFinished"), E(F, "The creative has expanded."), this.l(this.Ub, 0));
    };
    R.prototype.finishFullscreenExpand = R.prototype.hc;
    R.prototype.Gb = function () {
        "fs_expanded" != this.f
            ? D(F, "Enabler.requestFullscreenCollapse() should not be invoked unless the  creative is in the fullscreen state.")
            : (ig(this, "fullscreenCollapseStart") ||
                  D(F, "Please implement fullscreen collapse via event handlers:\nEnabler.addEventListener(\n    studio.events.StudioEvent.FULLSCREEN_COLLAPSE_START,\n    function() {/* Begin collapse animation */});"),
              ik(this),
              Q(this.F, "fullscreenCollapseRequested"),
              this.l(this.Ob, 0));
    };
    R.prototype.requestFullscreenCollapse = R.prototype.Gb;
    R.prototype.fc = function () {
        "fs_collapsing" != this.f
            ? D(F, "You must first call Enabler.requestFullscreenCollapse() to initiate the collapse and then call Enabler.finishFullscreenCollapse() when the collapse animation has finished. Cancelling collapse...")
            : (Q(this.F, "fullscreenCollapseFinished"), this.l(this.Sb, 0));
    };
    ...
    q("studio.sdk.hint.Hint", { EXPANSION_MODE: "expansionMode", EXPANSION_TRIGGER: "expansionTrigger" }, void 0);
    var yk,
        zk,
        Ak,
        Bk,
        ...
        Gk = Fk("(iPad") || Fk("(Macintosh") || Fk("(iPod") || Fk("(iPhone"),
        Hk = Fk("Android"),
        Ik = Fk("MSIE") || Fk("IEMobile") || Fk("Windows Phone"),
        Jk = function () {
    ...
    var gl = function (a, b) {
        ...
        if (b.na) throw Error("Component already rendered");
        ...
        cl(b, a);
        wb(a.b, c, 0, b);
        b.na && a.na && b.h == a ? ((a = a.ma()), (c = a.childNodes[c] || null), c != b.getElement() && a.insertBefore(b.getElement(), c)) : (a.a || a.ba(), (c = a.b ? a.b[c + 1] || null : null), dl(b, a.ma(), c ? c.a : null));
    };
