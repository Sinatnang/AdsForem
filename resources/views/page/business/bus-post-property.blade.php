...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/business/bus-financial/financial_1.png')}}" alt="" />
        <a href="{{asset('/read-business')}}">
            <img src="{{asset('images/business/bus-financial/financial_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/business/bus-financial/financial_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/business/bus-financial/financial_4.png')}}" alt="" />
        <img src="{{asset('images/business/bus-financial/financial_5.png')}}" alt="" />
        <img src="{{asset('images/business/bus-financial/financial_6.png')}}" alt="" />
    </div>
