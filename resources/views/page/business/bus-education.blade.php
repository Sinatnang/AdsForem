...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/business/bus-education/education_1.png')}}" alt="" />
        <a href="{{asset('/read-business')}}">
            <img src="{{asset('images/business/bus-education/education_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/business/bus-education/education_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/business/bus-education/education_4.png')}}" alt="" />
        <img src="{{asset('images/business/bus-education/education_5.png')}}" alt="" />
        <img src="{{asset('images/business/bus-education/education_6.png')}}" alt="" />
    </div>
