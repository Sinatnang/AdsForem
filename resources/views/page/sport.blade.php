...
<div class="row mt-2">
                ...
                <div class="col-8">
                    <img src="{{asset('images/sport/sport_1.png')}}" alt="" />
                        <a href="{{asset('/read-sport')}}">
                            <img src="{{asset('images/sport/sport_2.png')}}" alt="" />
                        </a>
                    <div >
                    ...
                    <img src="{{asset('images/sport/sport_3.png')}}" alt="">
                    <img src="{{asset('images/sport/sport_4.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/sport/sport_5.png')}}" alt="">
                    <img src="{{asset('images/sport/sport_6.png')}}" alt="">
                </div>
