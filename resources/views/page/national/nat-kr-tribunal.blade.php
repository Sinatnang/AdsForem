...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/national/kr-tribunal/kr-tribunal_1.png')}}" alt="" />
        <a href="{{asset('/read-national')}}">
            <img src="{{asset('images/national/kr-tribunal/kr-tribunal_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/national/kr-tribunal/kr-tribunal_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/national/kr-tribunal/kr-tribunal_4.png')}}" alt="" />
        <img src="{{asset('images/national/kr-tribunal/kr-tribunal_5.png')}}" alt="" />
        <img src="{{asset('images/national/kr-tribunal/kr-tribunal_6.png')}}" alt="" />
    </div>
