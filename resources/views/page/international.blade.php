...
@section('content')
            <div class="row mt-2">
                ...
                <div class="col-8">
                    <img src="{{asset('images/international/international_1.png')}}" alt="" />
                    <a href="{{asset('/read-international')}}">
                    <img src="{{asset('images/international/international_2.png')}}" alt="" />
                    </a>
                    <div >
                    ...
                    <img src="{{asset('images/international/international_3.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/international/international_4.png')}}" alt="">
                    <img src="{{asset('images/international/international_5.png')}}" alt="">
                    <img src="{{asset('images/international/international_6.png')}}" alt="">
                </div>
