...
*/
        ...
        g.goToPage = function (a, b, c, d, e) {
            this.a.length ? ((a = "number" == typeof a ? a : this.findPageIndexByAttributeValue("id", a)), 0 <= a && V(this, a, b, c, d, e)) : (this.I = a);
        };
        g.getPages = function () {
            return this.a;
        };
...
*/
        ...
        g.connectedCallback = function () {
            var a = this;
            this.V || ((this.J = this.hasAttribute("fullscreen")), (document.body.style.opacity = "0"), (this.V = !0));
            ...
            Enabler.addEventListener(studio.events.StudioEvent.FULLSCREEN_DIMENSIONS, this.S);
                ...
                if (b) {
                    ...
                    for (var d = 0; d < b.length; d++) {
                        ...
                        if (f) {
                            ...
                            e = { event: e.getAttribute("event"), ra: e.getAttribute("metric") || m, ea: e.hasAttribute("cumulative"), exit: m };
                            c.add(P(f), e);
                        }
                    }
                }
        ...
        g.disconnectedCallback = function () {
            ...
            Enabler.removeEventListener(studio.events.StudioEvent.FULLSCREEN_DIMENSIONS, this.S);
        ...
        g.fa = function (a) {
            this.b ? (this.h && this.b.removeEventListener("ready", this.h), (this.h = this.R.bind(this, a)), this.b.isDataLoaded() && this.h(), this.b.addEventListener("ready", this.h)) : a();
        };
        g.R = function (a) {
            var b = !!a;
            if (this.g) {
                ...
                c && ((b = this.a.getElementsBySelector("*")), (b = b.concat(this.a.getPages())), this.g.bindData(c, b) ? this.Z(a) : ((this.c = this.Z.bind(this, a)), this.g.addEventListener("bindingfinished", this.c)), (b = !1));
            }
            b && a();
        };
        g.Z = function (a) {
                ...
                if (a) {
                    ...
                    if (a.nodeType == Node.ELEMENT_NODE)
                        for (var d = w(c.i), e = 0; e < d.length; e++) {
                            var f = D(d[e]);
                            if (f && y(a, f)) for (var m = x(c.i, d[e]), C = 0; C < m.length; C++) f.removeEventListener(m[C].event, c.H, !1);
                        }
                    if ((a = a.querySelectorAll("video, gwd-video")) && 0 < a.length) for (this.P = []; this.O.length; ) studio.video.Reporter.detach(this.O.shift());
                }
                this.X.observe(b);
                (a = b.querySelectorAll("video, gwd-video")) &&
                    0 < a.length &&
                    ((b = studio.video && studio.video.Reporter), (c = this.sa.bind(this)), (this.P = Array.prototype.slice.call(a)), b ? c() : Enabler.loadModule(studio.module.ModuleId.VIDEO, c));
            }
        };
        g.sa = function () {
            for (var a, b; this.P.length; ) if (((b = this.P.shift()), (a = P(b)))) studio.video.Reporter.attach(a, "gwd-video" == b.tagName.toLowerCase() ? b.nativeElement : b, b.autoplay), this.O.push(a);
        };
        var P = function (a) {
