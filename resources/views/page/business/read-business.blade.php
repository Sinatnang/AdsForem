...
<div class="row mt-2">
    ...
    <img src="{{asset('images/business/read-business/business_1.png')}}" alt="" />
    <div class="col-8">
        <img src="{{asset('images/business/read-business/business_2.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/business/read-business/business_3.png')}}" alt="" />
        <div class="parallax"></div>

        <!-- <iframe width="700" height="400" src="https://www.youtube.com/embed/p8n3s5Y0jTY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->

        <img src="{{asset('images/business/read-business/business_4.png')}}" alt="" />
        <img src="{{asset('images/business/read-business/business_5.png')}}" alt="" />
        <img src="{{asset('images/business/read-business/business_6.png')}}" alt="" />
        <img src="{{asset('images/business/read-business/business_7.png')}}" alt="" />
    </div>
