...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_1.png')}}" alt="" />
        <a href="{{asset('/read-lifestyle')}}">
            <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_4.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_5.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-arts-culture/arts-culture_6.png')}}" alt="" />
    </div>
