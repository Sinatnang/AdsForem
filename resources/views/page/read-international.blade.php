...
<div class="row mt-2">
                ...
                <img src="{{asset('images/international/read-international/international_1.png')}}" alt="" />
                <div class="col-8">
                    <img src="{{asset('images/international/read-international/international_2.png')}}" alt="" />
                    <div >
                    ...
                    <img src="{{asset('images/international/read-international/international_3.png')}}" alt="">
                    <div class="parallax"></div>
                    <img src="{{asset('images/international/read-international/international_4.png')}}" alt="">
                    <img src="{{asset('images/international/read-international/international_5.png')}}" alt="">
                    <img src="{{asset('images/international/read-international/international_6.png')}}" alt="">
                </div>
                <div class="col-4 mt-1 block-ads">
                    ...
                    <img src="{{asset('images/international/read-international/international_7.png')}}" alt="">
                    <img src="{{asset('images/international/read-international/international_8.png')}}" alt="">
                    </div>
                </div>
@endsection
