...
<div class="row mt-2">
                ...
                <img src="{{asset('images/sport/read-sport/sport_1.png')}}" alt="" />
                <div class="col-8">
                    <img src="{{asset('images/sport/read-sport/sport_2.png')}}" alt="" />
                    <div >
                    ...
                    <img src="{{asset('images/sport/read-sport/sport_3.png')}}" alt="">
                    <div class="parallax"></div>
                    <img src="{{asset('images/sport/read-sport/sport_4.png')}}" alt="">
                    <img src="{{asset('images/sport/read-sport/sport_5.png')}}" alt="">
                </div>
                <div class="col-4 mt-1 block-ads">
                    ...
                    <img src="{{asset('images/sport/read-sport/sport_6.png')}}" alt="">
                    <img src="{{asset('images/sport/read-sport/sport_7.png')}}" alt="">
                    </div>
                </div>
@endsection
