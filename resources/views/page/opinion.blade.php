...
<div class="row mt-2">
                ...
                <div class="col-8">
                    <img src="{{asset('images/opinion/opinion_1.png')}}" alt="" />
                    <a href="{{asset('/read-opinion')}}">
                        <img src="{{asset('images/opinion/opinion_2.png')}}" alt="" />
                    <div >
                    ...
                    <img src="{{asset('images/opinion/opinion_3.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/opinion/opinion_4.png')}}" alt="">
                    <img src="{{asset('images/opinion/opinion_5.png')}}" alt="">
                    <img src="{{asset('images/opinion/opinion_6.png')}}" alt="">
                </div>
