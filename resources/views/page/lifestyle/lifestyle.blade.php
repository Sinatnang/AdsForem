...
<div class="row mt-2">
                ...
                <div class="col-8">
                    <img src="{{asset('images/lifestyle/lifestyle_1.png')}}" alt="" />
                    <a href="{{asset('/read-lifestyle')}}">
                        <img src="{{asset('images/lifestyle/lifestyle_2.png')}}" alt="" />
                    </a>
                    <div >
                    ...
                    <img src="{{asset('images/lifestyle/lifestyle_3.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/lifestyle/lifestyle_4.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/lifestyle_5.png')}}" alt="">
                    <img src="{{asset('images/lifestyle/lifestyle_6.png')}}" alt="">
                </div>
