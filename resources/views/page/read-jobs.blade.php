...
<div class="row mt-2">
                ...
                <img src="{{asset('images/jobs/read-jobs/job_1.png')}}" alt="" />
                <div class="col-8">
                    <img src="{{asset('images/jobs/read-jobs/job_2.png')}}" alt="" />
                    <!-- <a class="footclose" href="#" >
                    <img src="https://tpc.googlesyndication.com/simgad/8457811643808958112" alt="" style="margin-left: 15px;">
                    </a> -->
                    <img src="{{asset('images/jobs/read-jobs/job_3.png')}}" alt="">
                    <div class="parallax"></div>
                    <img src="{{asset('images/jobs/read-jobs/job_4.png')}}" alt="">
                    <!-- <a class="footclose" href="#" >
                    <img src="https://tpc.googlesyndication.com/simgad/8457811643808958112" alt="" style="margin-left: 25px;">
                    </a> -->
                    <img src="{{asset('images/jobs/read-jobs/job_5.png')}}" alt="">
                    <img src="{{asset('images/jobs/read-jobs/job_6.png')}}" alt="">
                    <div >
                    ...
                    <img src="{{asset('images/jobs/read-jobs/job_7.png')}}" alt="">
                    <img src="{{asset('images/jobs/read-jobs/job_8.png')}}" alt="">
                </div>
                <div class="col-4 mt-1 block-ads">
                    ...
                    <!-- <div class="container" style="margin-left:25px; border:1px black;">
                        <img src="{{asset('images/jobs/read-jobs/jobs_6.png')}}" alt="">
                    </div> -->
                </div>
@endsection
