...
<div class="row mt-2">
    ...
    <div class="col-8">
        <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_1.png')}}" alt="" />
        <a href="{{asset('/read-lifestyle')}}">
            <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_2.png')}}" alt="" />
        </a>
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_3.png')}}" alt="" />
        <div>
        ...
        <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_4.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_5.png')}}" alt="" />
        <img src="{{asset('images/lifestyle/life-around-ngos/around-ngos_6.png')}}" alt="" />
    </div>
