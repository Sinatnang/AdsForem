...
<div class="row mt-2">
                ...
                <img src="{{asset('images/travel/read-travel/travel_1.png')}}" alt="" />
                <div class="col-8">
                    <img src="{{asset('images/travel/read-travel/travel_2.png')}}" alt="" />
                    <div >
                    ...
                    <img src="{{asset('images/travel/read-travel/travel_3.png')}}" alt="">
                    <div class="parallax"></div>
                    <img src="{{asset('images/travel/read-travel/travel_4.png')}}" alt="">
                    <img src="{{asset('images/travel/read-travel/travel_5.png')}}" alt="">
                    <img src="{{asset('images/travel/read-travel/travel_6.png')}}" alt="">
                    <img src="{{asset('images/travel/read-travel/travel_7.png')}}" alt="">
                </div>
                <div class="col-4 mt-1 block-ads">
                    ...
                    <img src="{{asset('images/travel/read-travel/travel_8.png')}}" alt="">
                    <img src="{{asset('images/travel/read-travel/travel_9.png')}}" alt="">
                    </div>
                </div>
@endsection
